...
namespace YCIOT.ModbusPoll.Utils
{
     ...
     /// <summary>
     /// 通过table查找，与Checksum中的Hi,lo字节数组相反
     /// </summary>
     public static class CCRC16
     {
          ...
          public static byte[] CRC16_(this byte[] data)
          {
               ushort num = 0xffff;
               for (int i = 0; i < data.Length; i++)
               {
                    byte index = (byte)(data[i] ^ num);
                    num = (ushort)(num >> 8);
                    num = (ushort)(num ^ CRCTable[index]);
               }
